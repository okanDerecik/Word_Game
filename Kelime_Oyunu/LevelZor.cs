...
{
    public partial class LevelZor : Form
    {
        public LevelZor()
        {
            InitializeComponent();
        ...
        void sorugetir()
        {
            ...
            SqlCommand komut = new SqlCommand("Select * from TBL_ZOR where ID=@p1", bgl.baglanti());
        ...
        private void LevelZor_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (sayi == 21)
            {
                if (dogru == 20)
                {
                    MessageBox.Show("Tebrikler Başarılı Bir Şekilde Oyunu Bitirdiniz");
