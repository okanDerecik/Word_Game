...
{
    public partial class LevelKolay : Form
    {
        public LevelKolay()
        {
            InitializeComponent();
        ...
        void sorugetir()
        {
            ...
            SqlCommand komut = new SqlCommand("Select * from TBL_KOLAY where ID=@p1", bgl.baglanti());
        ...
        private void LevelKolay_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(sayi == 11)
            {
                if(dogru == 10)
                {
                    ...
                    LevelNormal fr = new LevelNormal();
                    fr.Show();
                    this.Hide();
                }else if(yanlis >=1 )
                {
